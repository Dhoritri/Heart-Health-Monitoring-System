...
CREATE TABLE `diagnosis_report` (
  `DiagnosisReportID` int NOT NULL AUTO_INCREMENT,
  `Date` date DEFAULT NULL,
  `Status` varchar(50) DEFAULT NULL,
  `DiagnosisID` int DEFAULT NULL,
  `PhysicianID` int DEFAULT NULL,
  PRIMARY KEY (`DiagnosisReportID`),
  KEY `DiagnosisID` (`DiagnosisID`),
  KEY `PhysicianID` (`PhysicianID`),
  CONSTRAINT `diagnosis_report_ibfk_1` FOREIGN KEY (`DiagnosisID`) REFERENCES `diagnosis` (`DiagnosisID`),
  CONSTRAINT `diagnosis_report_ibfk_2` FOREIGN KEY (`PhysicianID`) REFERENCES `physician` (`PhysicianID`)
...
INSERT INTO `diagnosis_report` VALUES (1,'2024-01-02','Confirmed',1,1),(2,'2024-02-02','Confirmed',2,2);
...
-- Dump completed on 2024-07-06 22:13:33
