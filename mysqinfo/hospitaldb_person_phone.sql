...
CREATE TABLE `person_phone` (
  ...
  `ID` int DEFAULT NULL,
  KEY `ID` (`ID`),
  CONSTRAINT `person_phone_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `person` (`ID`)
...
INSERT INTO `person_phone` VALUES ('123-456-7890',1),('234-567-8901',2),('345-678-9012',3),('456-789-0123',4);
