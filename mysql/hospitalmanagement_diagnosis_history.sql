...
CREATE TABLE `diagnosis_history` (
  ...
  PRIMARY KEY (`MH_ID`,`Diagnosis`),
  CONSTRAINT `diagnosis_history_ibfk_1` FOREIGN KEY (`MH_ID`) REFERENCES `medical_history` (`MH_ID`)
...
INSERT INTO `diagnosis_history` VALUES (1,'Hypertension'),(2,'Chronic Migraine');
