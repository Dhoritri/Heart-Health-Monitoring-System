...
CREATE TABLE `medicine_prescribed` (
  ...
  PRIMARY KEY (`PrescriptionID`,`Medicine`),
  CONSTRAINT `medicine_prescribed_ibfk_1` FOREIGN KEY (`PrescriptionID`) REFERENCES `prescription` (`PrescriptionID`)
...
INSERT INTO `medicine_prescribed` VALUES (1,'Lisinopril'),(2,'Sumatriptan');
