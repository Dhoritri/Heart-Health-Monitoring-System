...
--
-- Table structure for table `prescription_symptoms`
--
...
--
-- Dumping data for table `prescription_symptoms`
--

LOCK TABLES `prescription_symptoms` WRITE;
/*!40000 ALTER TABLE `prescription_symptoms` DISABLE KEYS */;
INSERT INTO `prescription_symptoms` VALUES ('Headache',2),('Nausea',2);
